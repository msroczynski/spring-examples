...
public final class SoapLoginUtil {
    ...
    //private static final String SERVICES_SOAP_PARTNER_ENDPOINT = "/services/Soap/u/26.0/";
    ...
    public static String[] login(HttpClient client, String soapURL, String username, String password)
...
/*    private static String getSoapURL() throws MalformedURLException {
        return new URL(StreamingClientWorker.LOGIN_ENDPOINT +
